  ...
  return (
    <div className='my-14 py-12'>
      <div className='container'>
        <h1 className='text-3xl text-center sm:text-5xl font-bold text-primary'>Pricing</h1>
       
        {/* Card Section */}
        <div className=' mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6 md:grid-cols-3'>
          {PricingData.map((data, index) => (
            <div key={index} className=' space-y-3 text-center bg-gray-200
             ...
             dark:hover:bg-primary/50 duration-200'>
              ...
              <p className='font-semibold text-xl py-3 '> Duration:{data.duration}</p>
