    ...
    <div className='py-10 my-10'>
      <div className='container'>
        ...
        <div className='text-center'>
          <h1 className='text-3xl text-center sm:text-5xl font-bold text-primary'>Testimonials</h1>
        </div>
                ...
                <div className='flex flex-col gap-4 shadow-lg py-8 px-6 mx-4 rounded-xl dark:bg-dark bg-primary/10'>
                  ...
                  <div className='flex flex-col items-center gap-4'>
                    <div className='space-y-3'>
                      <p className='text-xs font-serif text-primary/20 dark:text-white'>{data.text}</p>
                      <p className='text-black/80 dark:text-white'>{data.name}</p>
                    </div>
                  </div>
